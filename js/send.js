(function () {
  ...
  if (
    typeof get.utm_source != "undefined" ||
    typeof get.utm_medium != "undefined" ||
    typeof get.utm_campaign != "undefined" ||
    typeof get.utm_content != "undefined" ||
    typeof get.utm_term != "undefined" ||
    typeof get.yclid != "undefined" ||
    typeof get.gclid != "undefined"
  ) {
    setCookie(
      "prodex24source",
      get.utm_source || "",
    ...
    if (
      refer &&
      myURLhost.indexOf(window.location.hostname) == -1 &&
      window.location.hostname.indexOf(myURLhost) == -1
    ) {
      setCookie(
        "prodex24source_full",
        refer || "",
    ...
    if (
      ...
      if (typeof get.gclid != "undefined") {
        ...
        /^(((google|search\.yahoo|yandex|bing)(\.[^.]+)+)|(rambler\.ru)|(ukr\.net)|(mail\.ru))$/i.test(
          domain
        )
      ) {
        setCookie(
